...
\makeatletter
      ...
      \IfFileExists{paper-seb-main.aux}{%
      \input paper-seb-main.aux
      }{\typeout{You will need to run Latex on paper-seb-main.tex because we need its aux file}}
      }
\makeatother
...
\noindent
\IfFileExists{generated-supplementary.toc}{%
      \input generated-supplementary.toc
      }{\typeout{You will need to run Latex again on paper-seb-supplementary.tex because we need its .toc file}}
}
...
\vbox{\noindent\IfFileExists{generated-minicontents.tex}{%
      \input generated-minicontents.tex
      }{\typeout{You will need to run Latex again on paper-seb-supplementary.tex because we need its generated-minicontents.tex file}}}
