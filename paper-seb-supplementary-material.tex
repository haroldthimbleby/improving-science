...
%\subsection{Introduction and standard references}
...
\subsubsection{\emph{Journal of Vascular Surgery}}\label{vascular-surgery-note}
...
The \emph{Journal of Vascular Surgery\/} has detailed data policies, but no code policy. While no \emph{Journal of Vascular Surgery\/} papers were surveyed (but see section \ref{vascular-surgery-note}), the following statement on data policies is relevant:
