...
\highlightmysubsection{Sample assessments and criteria}
...
This is exactly the same table as table \ref{table-summary} from the main paper, reproduced here for convenience. See section \ref{data-methods-subsection} in this \supplement\ for details of the process that generated it.
