% 
% This file has been expanded from LaTeX file (appendix.tex)
%   to make this straight forward LaTeX file (expanded-appendix.tex)
%     that depends on nothing (it inputs no files apart from the document class files).
%       Each required file's text was input in situ - search for % expand
% 
% (Otherwise the file appendix.tex would use BibTeX, a macro file, tables of contents, its own and the other files's .aux files, and includes various files in generated/*, etc.)
% 
...
\bibcite{swebok}{{{139}{}{{}}{{}}}}
\bibcite{wpf}{{{140}{}{{}}{{}}}}
\@writefile{toc}{\contentsline {subsubsection}{\numberline {12.d.3}Problems of restrictive journal policies}{64}{subsubsection.12.4.3}\protected@file@percent }
\newlabel{supplement-restrictive-policies}{{12.d.3}{64}{Problems of restrictive journal policies}{subsubsection.12.4.3}{}}
...
\contentsline {subsection}{\numberline {12.b}Pilot paper sample}{54}{subsection.12.2}%
...
\contentsline {subsubsection}{\numberline {12.d.3}Problems of restrictive journal policies}{64}{subsubsection.12.4.3}%
...
Servick, K. and Enserink, M. (2020) ``A mysterious company's coronavirus papers
  in top medical journals may be unraveling,'' {\em Science}.
