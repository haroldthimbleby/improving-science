...
Finally, there is still a long way to go. The \emph{Computer Journal}, which should be a leading journal for publishing computational science (and which has published this paper) uses poorly documented automated and buggy paper processing software, whose obscure bugs took several weeks of hard work to overcome in order to submit the present paper. Such problems will put authors off using computational papers and \RAPstar\ methodologies.
