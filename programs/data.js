...
function saveFile(fileName, buffer, description) {
    ...
    if( fileName.endsWith(".tex") || fileName.endsWith(".bbl") )
    	buffer = "% Generated by programs/data.js\n"+buffer;
    	...
    	buffer = "Generated by programs/data.js\n"+buffer;
	else console.log("      *** File name suffix in "+fileName+" not recognized and therefore not signed...");
