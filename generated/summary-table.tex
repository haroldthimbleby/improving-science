...
Requested code actually made available (within 2 years 7 months${}^{\star}$)&0&0\%& \\\hline
...
\hline\end{tabular}\\
\vskip 1ex ${}^{\star}$Time of 2 years 7 months is wait between code request and date of generating this table.